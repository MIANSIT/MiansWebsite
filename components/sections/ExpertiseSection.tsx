    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <AnimatedSection className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-hind text-[var(--text-secondary)] text-sm tracking-widest uppercase">
                Our Expertise
              </span>
            </div>
          ...
          <p className="font-hind text-[var(--text-secondary)] max-w-md leading-relaxed">
            Six areas where we go beyond surface-level — delivering real,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          {/* Left: expertise list */}
          <div
            className="divide-y lg:border-r"
                ...
                <div className="py-6 lg:pr-12 flex items-start gap-5 group cursor-default">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1.5">
                      <h3 className="font-poppins font-semibold text-[var(--text-primary)] text-base">
                        {item.title}
                      </h3>
                      <span className="font-poppins font-light text-[var(--text-secondary)] text-sm opacity-40 ml-3 flex-shrink-0">
                        {item.num}
                      </span>
                    </div>
                    <p className="font-hind text-[var(--text-secondary)] text-sm leading-relaxed">
                      {item.desc}
                    </p>
                  </div>
                </div>
          ...
          <div className="hidden lg:block">
            <AnimatedSection delay={200}>
              ...
              <div className="relative mb-10" style={{ height: "300px" }}>
                <img
                  src="/images/expertiseVisual.png"
                  alt="MIANS digital agency UI showcase"
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, var(--bg-subtle) 0%, color-mix(in srgb, var(--bg-subtle) 30%, transparent) 50%, transparent 100%)",
                  }}
                />
                <div
                  className="absolute top-4 right-4 border px-3 py-1.5"
                  style={{
                    background: "var(--bg-card)",
                    borderColor: "var(--border)",
                  }}
                >
                  <span className="font-hind text-[var(--text-primary)] text-xs font-semibold">
                    Next.js
                  </span>
                </div>
                <div
                  className="absolute bottom-8 left-4 border px-3 py-1.5"
                  style={{
                    background: "var(--bg-card)",
                    borderColor: "var(--border)",
                  }}
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <p className="font-poppins font-semibold text-[var(--text-primary)] text-sm">
                      Powered By
                    </p>
                    <p className="font-hind text-[var(--text-muted)] text-xs mt-0.5">
                      Industry-standard tools, chosen for performance &amp;
                      reliability
                    </p>
                  </div>
                  {/* subtle pulse dot */}
