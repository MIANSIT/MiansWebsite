            ...
            <div className='sticky top-28 space-y-6'>
              ...
              <div className='space-y-3'>
                ...
                >
                  <div className='flex items-start gap-4'>
                    ...
                    <div className='flex-1'>
                      <p
                        className='font-hind text-xs uppercase tracking-wider mb-2'
                      ...
                      <div className='space-y-2'>
                        <div>
                          <a
                            href='tel:+8801833228622'
                            className='font-hind text-sm hover-underline block'
                            style={{ color: "var(--text-secondary)" }}
                          >
                            +880 1833 228 622
                          </a>
                          <span
                            className='font-hind text-[10px]'
                            style={{ color: "var(--text-muted)" }}
                          >
                            BD - Support
                          </span>
                ...
                {[
                  ...
                  {
                    label: "Facebook",
                    value: "mians.official",
                    href: "https://www.facebook.com/mians.official",
                    icon: (
                      <svg
                        className='w-4 h-4'
                        fill='currentColor'
                  ...
                  >
                    ...
                    <div>
                      <p
                        className='font-hind text-xs uppercase tracking-wider mb-0.5'
                        style={{ color: "var(--text-muted)" }}
                      >
                        {item.label}
                      </p>
              ...
              >
                ...
                <p
                  className='font-hind text-xs leading-relaxed'
                  style={{ color: "var(--text-secondary)" }}
                >
                  We review every message carefully. Expect a thoughtful
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className='space-y-5'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5'>
                  <div>
                    <label
                      className='font-hind text-xs uppercase tracking-wider block mb-2'
                      style={{ color: "var(--text-muted)" }}
                    >
                      Full Name *
                    </label>
                ...
                <div>
                  <label
                    className='font-hind text-xs uppercase tracking-wider block mb-3'
                    style={{ color: "var(--text-muted)" }}
                  >
